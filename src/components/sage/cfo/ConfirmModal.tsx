...
export function ConfirmModal({
  ...
  if (!open) return null;
  return (
    <div className="cfo-modal-overlay fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="cfo-confirm-title"
        className="w-full max-w-lg rounded-2xl border border-neutral-800 bg-[#0a0a0a] p-6 shadow-2xl"
      >
