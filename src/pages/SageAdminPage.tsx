      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm text-neutral-400">
            Internal development controls for Gmail, fixtures, dry-run and live Sage writes.
            The CFO demo is on the main page.
          </p>
          <Link
            to="/sage-integration"
            className="mt-2 inline-block text-xs text-neutral-400 underline hover:text-white"
          >
            ← Back to Ghostboards Demo
          </Link>
        </div>
